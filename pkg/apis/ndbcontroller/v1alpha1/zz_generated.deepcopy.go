...
func (in *NdbClusterSpec) DeepCopyInto(out *NdbClusterSpec) {
	*out = *in
	if in.DataNodeConfig != nil {
		in, out := &in.DataNodeConfig, &out.DataNodeConfig
	...
	if in.ManagementNodePodSpec != nil {
		in, out := &in.ManagementNodePodSpec, &out.ManagementNodePodSpec
		*out = new(NdbPodSpec)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NdbPodSpec) DeepCopyInto(out *NdbPodSpec) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NdbPodSpec.
func (in *NdbPodSpec) DeepCopy() *NdbPodSpec {
	if in == nil {
		return nil
	}
	out := new(NdbPodSpec)
