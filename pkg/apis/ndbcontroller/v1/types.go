...
type NdbClusterSpec struct {
	...
	// If not specified, "container-registry.oracle.com/mysql/community-cluster:8.4.1" will be used.
	// +kubebuilder:default="container-registry.oracle.com/mysql/community-cluster:8.4.1"
	// +optional
