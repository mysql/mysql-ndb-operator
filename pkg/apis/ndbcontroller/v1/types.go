...
type NdbClusterSpec struct {
	...
	// If not specified, "container-registry.oracle.com/mysql/community-cluster:8.4.9" will be used.
	// +kubebuilder:default="container-registry.oracle.com/mysql/community-cluster:8.4.9"
	// +optional
