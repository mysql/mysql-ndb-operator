...
type NdbClusterSpec struct {
	...
	// If not specified, "container-registry.oracle.com/mysql/community-cluster:9.0.1" will be used.
	// +kubebuilder:default="container-registry.oracle.com/mysql/community-cluster:9.0.1"
	// +optional
